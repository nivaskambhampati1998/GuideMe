...
from .views import CurrentUserView, RegisterGuideView, VerifyEmail, RegisterTouristView, DeleteAccount, LogoutAPIView,SetNewPasswordAPIView,LoginAPIView,PasswordTokenCheckAPI,RequestPasswordResetEmail
